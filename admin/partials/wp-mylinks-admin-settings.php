...
function wp_mylinks_register_settings()
{
    ...
    register_setting('mylinks-custom-scripts', 'wp_mylinks_open_body_script');
...
?>
    <div class="wrap wp_mylinks_pluginpage_title">
        <h1><?php esc_html_e('WP MyLinks', 'mylinks'); ?></h1>
        <hr>
        <h2 class="nav-tab-wrapper">
            <a href="?post_type=mylink&page=welcome" class="nav-tab <?php echo esc_attr($active_tab == 'welcome' ? 'nav-tab-active' : ''); ?>"><?php esc_html_e('Welcome', 'wp-mylinks'); ?></a>
            <a href="?post_type=mylink&page=welcome&tab=global" class="nav-tab <?php echo esc_attr($active_tab == 'global' ? 'nav-tab-active' : ''); ?>"><?php esc_html_e('Global', 'wp-mylinks'); ?></a>
            <a href="?post_type=mylink&page=welcome&tab=script" class="nav-tab <?php echo esc_attr($active_tab == 'script' ? 'nav-tab-active' : ''); ?>"><?php esc_html_e('Custom Script', 'wp-mylinks'); ?></a>
            <a href="?post_type=mylink&page=welcome&tab=tutorial_support" class="nav-tab <?php echo esc_attr($active_tab == 'tutorial_support' ? 'nav-tab-active' : ''); ?>"><?php esc_html_e('Support', 'wp-mylinks'); ?></a>
        </h2>
            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table">
                    <tbody>
                        <tr class="wp_mylinks_options">
                            <th scope="row">
                                <label class="mylinks_misc" for="meta_title"><b><?php esc_html_e('Analytics Script', 'wp-mylinks'); ?></b></label>
                            </th>
                            <td>
                                <textarea name="wp_mylinks_analytics" class="mylinks_input_textarea" rows="5"><?php echo esc_textarea(get_option('wp_mylinks_analytics')); ?></textarea>
                ...
                <table class="form-table">
                    <tbody>
                        ...
                        <tr class="wp_mylinks_options">
                            <th scope="row">
                                <label class="mylinks_misc" for="custom_scripts"><b><?php _e('After Body Tag', 'wp-mylinks'); ?></b></label>
                            </th>
                            <td>
                                <textarea name="wp_mylinks_open_body_script" class="mylinks_input_textarea" rows="5"><?php echo get_option('wp_mylinks_open_body_script'); ?></textarea>
                                <p class="input-description">
                                    <?php _e('Inserted script will be placed after the opening <code>&lt;body&gt;</code> tag. Please include the <code>&lt;script&gt;</code>...<code>&lt;/script&gt;</code> tags', 'wp-mylinks'); ?>
                                </p>
                            </td>
                        </tr>
                        <tr class="wp_mylinks_options">
                    ...
                    <tbody>
                        <tr class="wp_mylinks_options">
                            ...
                            <td>
                                ...
                                <p class="input-description">
                                    <?php _e('Add your custom css code <b>without</b> the <code>&lt;style&gt;</code> tag.', 'wp-mylinks'); ?>
                                </p>
                            </td>
                        </tr>
                    </tbody>
            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table">
                    <tbody>
                        <tr class="wp_mylinks_options">
                            ...
                            <td>
                                <?php $theme_options = esc_attr(get_option('mylinks_theme')); ?>
                                <select name="mylinks_theme" class="mylinks_input_select">
                                    <option name="mylinks_theme" value='default' <?php selected($theme_options, 'default'); ?>><?php esc_html_e('Default', 'wp-mylinks'); ?></option>
                                    <option name="mylinks_theme" value='merbabu' <?php selected($theme_options, 'merbabu'); ?>><?php esc_html_e('Merbabu', 'wp-mylinks'); ?></option>
                                    <option name="mylinks_theme" value='cikuray' <?php selected($theme_options, 'cikuray'); ?>><?php esc_html_e('Cikuray', 'wp-mylinks'); ?></option>
                                    <option name="mylinks_theme" value='ciremai' <?php selected($theme_options, 'ciremai'); ?>><?php esc_html_e('Ciremai', 'wp-mylinks'); ?></option>
                                    <option name="mylinks_theme" value='slamet' <?php selected($theme_options, 'slamet'); ?>><?php esc_html_e('Slamet', 'wp-mylinks'); ?></option>
                                    <option name="mylinks_theme" value='papandayan' <?php selected($theme_options, 'papandayan'); ?>><?php esc_html_e('Papandayan', 'wp-mylinks'); ?></option>
                                    <option name="mylinks_theme" value='sindoro' <?php selected($theme_options, 'sindoro'); ?>><?php esc_html_e('Sindoro', 'wp-mylinks'); ?></option>
                                    <option name="mylinks_theme" value='krakatau' <?php selected($theme_options, 'krakatau'); ?>><?php esc_html_e('Krakatau', 'wp-mylinks'); ?></option>
                                    <option name="mylinks_theme" value='bromo' <?php selected($theme_options, 'bromo'); ?>><?php esc_html_e('Bromo', 'wp-mylinks'); ?></option>
                                    <option name="mylinks_theme" value='prau' <?php selected($theme_options, 'prau'); ?>><?php esc_html_e('Prau', 'wp-mylinks'); ?></option>
                                    <option name="mylinks_theme" value='polos' <?php selected($theme_options, 'polos'); ?>><?php esc_html_e('Polos', 'wp-mylinks'); ?></option>
                                    <option name="mylinks_theme" value='datar' <?php selected($theme_options, 'datar'); ?>><?php esc_html_e('Datar', 'wp-mylinks'); ?></option>
                                    <option name="mylinks_theme" value='pastel' <?php selected($theme_options, 'pastel'); ?>><?php esc_html_e('Pastel', 'wp-mylinks'); ?></option>
                                    <option name="mylinks_theme" value='kopi-hitam' <?php selected($theme_options, 'kopi-hitam'); ?>><?php esc_html_e('Kopi Hitam', 'wp-mylinks'); ?></option>
                                    <option name="mylinks_theme" value='kopi-susu' <?php selected($theme_options, 'kopi-susu'); ?>><?php esc_html_e('Kopi Susu', 'wp-mylinks'); ?></option>
                                    <option name="mylinks_theme" value='klepon' <?php selected($theme_options, 'klepon'); ?>><?php esc_html_e('Klepon Viral', 'wp-mylinks'); ?></option>
                                </select>
                ...
                <table class="form-table">
                    <tbody>
                        ...
                        <p>
                            <?php esc_html_e('Meta tags for the MyLinks page, will be shown both on search engine result and browser tab. If you use Yoast SEO or built-in<br> <strong>Setup Meta Tags</strong> form and already set both the <code>meta title</code> and <code>description</code> on MyLinks post editor, they will be used<br> instead of below values.', 'wp-mylinks'); ?>
                            <br />
                        </p>
                        <tr class="wp_mylinks_options">
                            <th scope="row">
            ...
            <div class="wrap">
                <div class="feature-section one-col wrap about-wrap">
                    <div class="about-text">
                        <h4><?php _e("<strong>WP MyLinks</strong> is Waiting for Your Feedback", 'wp-mylinks'); ?></h>
                    </div>
                    <div class="indo-about-description">
                        <?php _e("<strong>WP MyLinks</strong> is my fourth plugin and it's open source. I acknowledge that there are still a lot to fix, here and there, that's why I really need your feedback. <br>Send a feedback through some of below options to contact me:", 'wp-mylinks'); ?>
                    </div>
                    ...
                    <table class="tg" style="table-layout: fixed; width: 269px">
                        ...
                        <tr>
                            ...
                            <td class="tg-fymr"><a href="https://walterpinem.com/" target="_blank">
                                    <?php _e('walterpinem.com', 'wp-mylinks'); ?></a></td>
                        </tr>
                        <tr>
            ...
            <div class="wrap">
                <div class="feature-section one-col wrap about-wrap">
                    ...
                    <div class="mylinks-title">
                        ...
                        <img src="<?php echo esc_url(plugin_dir_url(dirname(__FILE__)) . 'images/wp-mylinks.png'); ?>" />
                    </div>
                    ...
                    <div class="feature-section one-col indo-about-description">
                        ...
                        <a href="https://walterpinem.me/projects/customization-service/?utm_source=mylink-welcome-tab&utm_medium=sidebar&utm_campaign=WP-MyLinks" target="_blank" class="button button-primary button-hero" style="text-align:center;display:block;margin:20px auto;">
                            <?php esc_html_e("Send Inquiry", 'wp-mylinks'); ?>
                        </a>
                    </div>
                    <div class="clear"></div>
                    <hr />
                    ...
                    <div class="feature-section one-col">
                        <div class="indo-get-started">
                            ...
                            <ul>
                                <li><strong><?php esc_html_e('Step #1:', 'wp-mylinks'); ?></strong> <?php _e('Build your very first micro landing page on <a href="post-new.php?post_type=mylink" target="_blank"><strong>New MyLink</strong></a> page.', 'wp-mylinks'); ?></li>
                                ...
                                <li><strong><?php esc_html_e('Step #5:', 'wp-mylinks'); ?></strong> <?php _e('Setup global settings for your micro landing pages on <a href="edit.php?post_type=mylink&page=welcome&tab=global" target="_blank"><strong>Global Configurations</strong></a> setting panel.', 'wp-mylinks'); ?></li>
                                <li><strong><?php esc_html_e('Step #6:', 'wp-mylinks'); ?></strong> <?php _e('Add custom styles and scripts to your micro landing pages on <a href="edit.php?post_type=mylink&page=welcome&tab=script" target="_blank"><strong>Custom Script</strong></a> setting panel.', 'wp-mylinks'); ?></li>
                                <li><strong><?php esc_html_e('Step #7:', 'wp-mylinks'); ?></strong> <?php _e('<strong>Have an inquiry?</strong> Find out how to reach out to me on <a href="edit.php?post_type=mylink&page=welcome&tab=tutorial_support" target="_blank"><strong>Support</strong></a> panel.', 'wp-mylinks'); ?></li>
                            </ul>
                            <hr />
                            <p><?php _e('If you encounter 404 page not found issue, please follow the steps below:', 'wp-mylinks'); ?></p>
                            <ol>
                                <li><?php _e('Go to <b>Settings</b> => <a href="options-permalink.php"><b>Permalinks</b></a> page.', 'wp-mylinks'); ?></li>
                                <li><?php _e('Click the <b>Save Changes</b> button without having to change anything.', 'wp-mylinks'); ?></li>
                    ...
                    <div class="feature-section two-col">
                        <div class="col">
                            <img src="<?php echo esc_url(plugin_dir_url(dirname(__FILE__)) . 'images/unlimited.png'); ?>" />
                        ...
                        <div class="col">
                            <img src="<?php echo esc_url(plugin_dir_url(dirname(__FILE__)) . 'images/one-link.png'); ?>" />
                    ...
                    <div class="feature-section two-col">
                        <div class="col">
                            <img src="<?php echo esc_url(plugin_dir_url(dirname(__FILE__)) . 'images/own-brand.png'); ?>" />
                        ...
                        <div class="col">
                            <img src="<?php echo esc_url(plugin_dir_url(dirname(__FILE__)) . 'images/custom-themes.png'); ?>" />
                    ...
                    <div class="feature-section two-col">
                        <div class="col">
                            <img src="<?php echo esc_url(plugin_dir_url(dirname(__FILE__)) . 'images/custom-scripts.png'); ?>" />
                        ...
                        <div class="col">
                            <img src="<?php echo esc_url(plugin_dir_url(dirname(__FILE__)) . 'images/documentation.png'); ?>" />
